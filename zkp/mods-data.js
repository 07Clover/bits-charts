const MODS_DATA = [
    ...
    },
    {
        ...
        diffs: ["hard"],
        description: "Pico x Nene Goted ashjbakfbkjsab lol V-Slice",
        videos: [{ id: "09bBxDXufno", label: "Gameplay Preview" }],
        songs: [{ num: "01", name: "Tutorial (Pico Mix)", diffs: ["easy", "normal", "hard"], bpm: 110 },
        ...
        credits: [
            ...
            { role: "Extended",     icon: "🎵", people: [{ name: "Jake The Artist" }] },
            { role: "Oiiai Cover",  icon: "🎵", people: [{ name: "Fab-BeatZ" }] },
